...
2. **Match Format**: All matches are played as **Single-Game Knockout**. 1 game decides the match.
3. **Point Scoring**:
...
6. **Code of Conduct**: Players must report to the Main Carrom Board within 5 minutes of their match being called.`
    },
    drawsPublished: {
