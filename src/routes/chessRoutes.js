...
router.put('/admin/matches/:id/live-score', chessAdminAuth, adminCtrl.updateLiveCaptures);
router.patch('/admin/matches/:id/live-score', chessAdminAuth, adminCtrl.updateLiveCaptures);
